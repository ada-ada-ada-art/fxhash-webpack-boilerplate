...
If you are looking for a simpler boilerplate, you can use the [fxhash simple boilerplate](https://github.com/ada-ada-ada-art/fxhash-simple-boilerplate) instead.
